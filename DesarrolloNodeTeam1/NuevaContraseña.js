class ErrorDeContrasena extends Error {
  ...
  function NuevaContrasena(newpss, numSeg) {
    ...
    const user = "edgAdm7";
    // EXCEPCIONES
    if (newpss.length < 6) throw new ErrorDeContraseña(-2, "El String de entrada, minimo tiene que tener 6 caracteres", newpss);
    if (newpss.length > 10) throw new ErrorDeContraseña(-3, "El String de entrada, maximo tiene que tener 10 caracteres", newpss);
  ...
  try {
    console.log(NuevaContrasena('EdH.Yiopol',blindNum.initNum()));   //**********************************************************MODULE
  } catch (error) {
...
console.log(NuevaContrasena("pruebas",123));
